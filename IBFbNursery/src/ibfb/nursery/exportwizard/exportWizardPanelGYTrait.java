...
public class exportWizardPanelGYTrait implements WizardDescriptor.Panel, PropertyChangeListener {
    ...
    public void readSettings(Object settings) {
       NurseryEditorTopComponent nurseryEditor = (NurseryEditorTopComponent) WindowManager.getDefault().getRegistry().getActivated();
        component.fillTraitList(nurseryEditor.getSelectedTraits());      
    ...
    public void storeSettings(Object settings) {
        NurseryEditorTopComponent nurseryEditor = (NurseryEditorTopComponent) WindowManager.getDefault().getRegistry().getActivated();
        nurseryEditor.setTraitToEvaluate(component.getElTrait());
        if (component.getElTrait() == null) {
            return;
        }
        nurseryEditor.setStringTraitToEvaluate(component.getElTrait().getVariateName());
