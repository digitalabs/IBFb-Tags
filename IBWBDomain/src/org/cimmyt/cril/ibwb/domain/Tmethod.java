...
@Entity
@Table(name = "tmethod")
public class Tmethod extends BaseFilter implements Serializable {
    ...
    public Tmethod(boolean atrNulls) {
    	if(!atrNulls)
    		setDefault();
    }
    ...
    public Tmethod(Integer tmethid) {
        this.tmethid = tmethid;
    }

    public Tmethod(Integer tmethid, String tmname, Integer traitid, String tmabbr, String tmdesc) {
        this.tmethid = tmethid;
        this.tmname = tmname;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Tmethod)) {
            return false;
        }
        Tmethod other = (Tmethod) object;
    ...
    public String toString() {
        //return "org.cimmyt.cril.ibworkbench.services.beans.Tmethod[tmethid=" + tmethid + "]";
        return tmname;
    }
