 ...
 */
@Embeddable
public class DataCPK implements Serializable {
    ...
    public DataCPK(Integer ounitid, Integer variatid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DataCPK)) {
            return false;
        }
        DataCPK other = (DataCPK) object;
    ...
    public String toString() {
        return "org.cimmyt.cril.ibworkbench.services.beans.DataCPK[ounitid=" + ounitid + ", variatid=" + variatid + "]";
    }
