...
public class ConditionsRowEditor implements TableCellEditor {
    ...
    public ConditionsRowEditor(JTable table,int entries) {
        this.table = table;
    ...
    private void createEditors(int entries) {
        ...
        for (int i = entries-1; i > 1; i--) {
          if( (entries % i)==0 ){
              ...
              rep2.addItem(entries / i);
          }
        }

        rep2.setSelectedItem(rep2.getItemAt(0));
        ...
        rep3.setSelectedItem(rep3.getItemAt(0));
        ...
        rep4.setSelectedItem(rep4.getItemAt(0));
