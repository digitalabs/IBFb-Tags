 ...
 * @author TMSANCHEZ
 */
public class GermplasmTransferHandlerSelection extends TransferHandler {
    ...
    public GermplasmTransferHandlerSelection(JTable sourceTable, JTable destTable, List<List<Object>> sourceList, List<List<Object>> destList) {
        ...
        public GermplasmTransferHandlerSelection(JTable sourceTable,JTable sourceTable2, JTable destTable, List<List<Object>> sourceList, List<List<Object>> destList) {
        this.sourceTable = sourceTable;
        this.destTable = destTable;
        this.sourceList = sourceList;
        this.destList = destList;
