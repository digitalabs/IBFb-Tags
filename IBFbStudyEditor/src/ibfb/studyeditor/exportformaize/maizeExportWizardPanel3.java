...
public class maizeExportWizardPanel3 implements WizardDescriptor.Panel<WizardDescriptor>, DocumentListener {

    private boolean isValid = false;
    private Set<ChangeListener> listeners = new HashSet<ChangeListener>(1);
    private maizeExportVisualPanel3 component;

    @Override
    public maizeExportVisualPanel3 getComponent() {
        if (component == null) {
            component = new maizeExportVisualPanel3();
    ...
    public void readSettings(WizardDescriptor wiz) {
        ...
        component.setOpcionFiltro(studyEditor.opcionFiltro);
    }

    @Override
    public void storeSettings(WizardDescriptor wiz) {
        StudyEditorTopComponent studyEditor = (StudyEditorTopComponent) WindowManager.getDefault().getRegistry().getActivated();
        studyEditor.trialFile = component.getNombreArchivo();
    }
