...
public final class maizeExportVisualPanel3 extends JPanel {

    private ResourceBundle bundle = NbBundle.getBundle(maizeExportVisualPanel3.class);
    private JFileChooser selectorArchivo = new JFileChooser();
    private String nombreArchivo = "";
    private int opcionFiltro = 0; //0=xls, 1=csv

    public maizeExportVisualPanel3() {
        initComponents();
    ...
    public String getName() {
         return bundle.getString("maizeExportVisualPanel3.name");
    }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblSelectDestinationFile, org.openide.util.NbBundle.getMessage(maizeExportVisualPanel3.class, "maizeExportVisualPanel3.lblSelectDestinationFile.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jButtonSearch, org.openide.util.NbBundle.getMessage(maizeExportVisualPanel3.class, "maizeExportVisualPanel3.jButtonSearch.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblImgFolders, org.openide.util.NbBundle.getMessage(maizeExportVisualPanel3.class, "maizeExportVisualPanel3.lblImgFolders.text")); // NOI18N
