 ...
 * @author TMSANCHEZ
 */
public class SelectConditionItemListener implements ActionListener {
    ...
    public SelectConditionItemListener(JTable table) {
        this.table = table;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // get table model
        StudyConditionsTableModel studyConditionsTableModel = (StudyConditionsTableModel) table.getModel();
        // then get current row
        Condition condition = studyConditionsTableModel.getStudyConditions().get(row);
